...
| 広告リンク | 0本。`affiliateEnabled` は `false`。もしもアフィリエイトに**メディア登録済み（審査中）** |
...
## もしもアフィリエイト（2026-09-07・**メディア登録済み・審査中**）
...
| カテゴリ | 金融・保険 > その他 |
| 月間PV | 0から100（**実数は未確認**。最小区分を選んだ） |
| 状態 | **審査中**。提携数 0。**2026-09-16 に管理画面で再確認したが、まだ審査中のまま**（登録は 09-07。FAQ は「通常2〜3営業日」と言っているので、7営業日を超えて止まっている） |

⚠️ **本人が旧メディア「Nexeed Blog」（blog.nexeed-web.com）を削除した。提携中だった450件は全部消えた。**
画面の注記によれば**「本人削除」は再審査・復活ができない。**

⚠️ **登録フォームの「楽天市場の商品購入」は既定でチェックが入っている。**
依頼が「メディア登録」だったので外して登録した。即時提携なので後から1クリックで足せる。

### 調べた結果（もしもの案件と、この記事群の相性）

| 記事の系統 | 使えるもの |
|---|---|
| 確定申告（医療費控除・ふるさと納税・住宅ローン減税） | 弥生シリーズ（審査なし・300〜2,000円）／マネーフォワードクラウド（審査なし・500〜700円） |
| ふるさと納税 | ポケマルふるさと納税200円／ふるさと納税ニッポン308円。**さとふる・ふるなび・楽天ふるさと納税は もしも に無い**。楽天市場（2%・即時提携）経由が現実的 |
| 相続・保険 | 保険のトータルプロフェッショナル13,800円（審査なし）／みんなの生命保険アドバイザー15,000円／ガーデン各種11,500円／FPの窓口5,000円（審査なし） |
| 資産形成 | bloomo（投資アプリ口座開設）3,520円／マネイロ／IOSマネーセミナー5,200円（審査なし） |
| 教育費 | ガーデン「学資金の無料相談」11,500円。**奨学金・教育ローンは0件** |
| 保育 | **保育士の転職サービスだけ。読者（保護者）と合わない** |

⚠️ **大手ネット証券（SBI・楽天証券・マネックス）は もしも に無い。** 証券口座は bloomo のみ。
大手は A8・バリューコマース側。

⚠️ **火災保険申請サポート系（12,000〜16,000円）は候補から外すことを勧めた。**
「火災保険で自宅を無料リフォーム」の訴求は国民生活センターが繰り返し注意喚起している類型で、
公的機関の原文を引くサイトに置くと信頼性を直接損なう。**単価は高い。判断は本人。**
...
2. **もしもアフィリエイトの審査結果を見る。** 2026-09-16 時点でまだ審査中（FAQ の目安 2〜3営業日を超過）。長引くようなら問い合わせを検討。通ったら提携申請。**判断待ち**（どれに申請するか）。
   16本になったので、相続・年金の記事に保険相談・FP相談、資産形成の記事に証券系が置ける
