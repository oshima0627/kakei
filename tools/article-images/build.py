...
SLIDES = [
    ...
    },
    {
        ...
        "subtitle": "確定申告すると無効",
        "subtitle_size": 28,
        # 物語: 確定申告 → ワンストップに大きな×。5団体は載せない。
        "labels": [
            {"at": (109, 48), "text": "確定申告", "size": 22, "align": "center",
             "width": Inches(2.0)},
            {"at": (391, 48), "text": "ワンストップ", "size": 22, "align": "center",
             "width": Inches(2.1)},
            {"at": (391, 400), "text": "無効", "size": 28, "align": "center",
             "width": Inches(1.6), "bold": True},
        ],
        "note": "",
    },
    {
